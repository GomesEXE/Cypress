    ...
    describe('Helpers...', () => {
      it('Wrap', () => {
        ...
        //   })
          ...
          cy.get('#buttonSimple').then(() => console.log('Encnotei o primeiro botao'))
          cy.wrap(promise).then(ret => console.log(ret))
          cy.get('#buttonList').then(() => console.log('Encnotei o segundo botao'))
        ...
        it.only('invoke', () => {
            ...
            cy.window().invoke('alert', 'dap pra ver?')
            cy.get('#resultado')
